...
pub(super) async fn write_handshake<I>(input: &mut I, username_or_hash: Box<str>) -> IoResult<()>
where
    I: AsyncWriteExt + Unpin,
{
...
pub(super) async fn write_spawn_position<I>(input: &mut I, x: i32, y: i32, z: i32) -> IoResult<()>
where
    I: AsyncWriteExt + Unpin,
{
